 ...
 * <!-- end-user-doc -->
 * @see se.gu.cse.idxse.bomi.BomiPackage#getDriverType()
 * @model
 * @generated
 */
public enum DriverType implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<DriverType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
